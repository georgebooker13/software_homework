...
import com.hebin.utils.hammingutils;
import com.hebin.utils.simhash;
import com.hebin.utils.writeread;

public class MainPaperCheck {

    public static void main(String[] args) {
        // 从命令行输入的路径名读取对应的文件，将文件的内容转化为对应的字符串
        String str0 = writeread.readTxt(args[0]);
        String str1 = writeread.readTxt(args[1]);
        ...
        // 把相似度写入最后的结果文件中
        writeread.writeTxt(similarity, resultFileName);
        // 退出程序
        System.exit(0);
    }
